...
ax2.plot(sig, data2, linestyle='-', color='red', label='ACP_SVM')
ax2.plot(sig, sig, linestyle='--', color='black')
ax2.set_xlabel("Significance", fontsize=10, fontweight='bold')
...
ax3.plot(sig, data3, linestyle='-', color='red', label='ICP_RF')
ax3.plot(sig, sig, linestyle='--', color='black')
ax3.set_xlabel("Significance", fontsize=10, fontweight='bold')
...
ax4.plot(sig, data4, linestyle='-', color='red', label='ACP_RF')
ax4.plot(sig, sig, linestyle='--', color='black')
ax4.set_xlabel("Significance", fontsize=10, fontweight='bold')
